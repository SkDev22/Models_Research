...
# # New endpoint to accept image uploads and predict using Keras model
...
#         temp_path = os.path.join(models_dir, "temp_image.jpg")
#         file.save(temp_path)
...
#         }
#         # Optionally remove temp file after prediction
#         os.remove(temp_path)
